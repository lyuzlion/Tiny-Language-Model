...
```bash
cd ./trainer
torchrun --nproc_per_node=4 train_full_sft.py --model_path /home/xxx/data/models/Tiny-Language-Model/pretrain/pretrain_768_epoch2.pth
```

### LoRA Fine-Tuning
```bash
torchrun --nproc_per_node=4 train_lora.py --model_path /home/xxx/data/models/Tiny-Language-Model/full_sft/full_sft_768_epoch1.pth
```

### DPO
```bash
torchrun --nproc_per_node=4 train_dpo.py --model_path /home/xxx/data/models/Tiny-Language-Model/full_sft/full_sft_768_epoch1.pth
```
...
```bash
python inference.py --model_path /home/xxx/data/models/Tiny-Language-Model/pretrain/pretrain_768_epoch2.pth --weight pretrain
