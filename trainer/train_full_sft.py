...
def main():
    ...
    parser.add_argument('--data_path', type=str, default='/home/liuzilong/data/datasets/sft_512.jsonl', help='Path to the training data')
    ...
    for epoch in range(args.epochs):
        ...
        if torch.distributed.get_rank() == 0:
            save_checkpoint(model=model, epoch=epoch, save_dir=args.output_dir, method='full_sft', config=config)
